...
// Example: node scripts/quick-changeset.mjs minor --pkg @agent-fabric/agents-sdk --pkg agents-core "Add streaming support"
...
Examples:
  ...
  pnpm bump minor --pkg @agent-fabric/agents-sdk --pkg agents-core "Add streaming response support"
`);
}
