...
const envSchema = z.object({
  ...
  // JWT (shared with @agent-fabric/agents-core — required in production for Slack user/link tokens)
  AGENT_FABRIC_AGENTS_JWT_SIGNING_SECRET: z
    .string()
    .optional()
    .describe(
  ...
  // API URLs
  AGENT_FABRIC_AGENTS_API_URL: z.string().optional().describe('Agent Fabric API URL'),

  // Slack execution-mode override
  AGENT_FABRIC_SLACK_DISABLE_DURABLE_EXECUTION: z
    .stringbool()
    .default(false)
    .catch(false)
    .describe(
