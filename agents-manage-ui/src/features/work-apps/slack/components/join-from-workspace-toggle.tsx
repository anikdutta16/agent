...
export function JoinFromWorkspaceToggle() {
  ...
  const handleToggle = async (enabled: boolean) => {
    ...
    try {
      ...
      toast.success(
        enabled
          ? 'Any user from this Slack workspace can now join your Agent Fabric organization.'
  ...
  return (
    <Card className="shadow-none">
      <CardHeader>
        ...
        <CardDescription>
          Allow any user from this Slack workspace to join your Agent Fabric organization.
        </CardDescription>
      </CardHeader>
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              <p>
                ...
                <code className="bg-muted px-1 py-0.5 rounded">/agent-fabric link</code>, they'll be
                prompted to create an Agent Fabric account and join your organization.
              </p>
            </AlertDescription>
          </Alert>
        )}
