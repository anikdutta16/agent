...
import { SUPPORT_COPILOT_PLATFORMS } from '@agent-fabric/agents-core/client-exports';
...
const CHROME_STORE_URL =
  'https://chromewebstore.google.com/detail/agent-fabric-ai-agents/lgjppelahndeddnljphpddakaccjdeig';
...
function buildSteps(platformLabel: string | undefined, isZendesk: boolean): StepContent[] {
  if (isZendesk) {
    return [
      {
        title: 'Install the Agent Fabric app from the Zendesk Marketplace',
        description:
          'Add the Agent Fabric app to your Zendesk account from the Zendesk Marketplace. A Zendesk admin must approve the install.',
        link: { url: ZENDESK_MARKETPLACE_URL, label: 'Open Zendesk Marketplace' },
      },
      {
        title: 'Log in',
        description:
          'Open any ticket in Zendesk and log in with your Agent Fabric account. The app will detect your workspace automatically.',
        hint: "Requires project membership — contact your admin if you can't sign in.",
      },
      {
        title: 'Open a ticket in Zendesk',
        description:
          'The Agent Fabric app appears in the ticket sidebar. Your configured quick actions will show at the top — click one to send its message.',
      },
    ];
  }
  ...
  return [
    {
      title: 'Install the Agent Fabric AI Agents extension',
      description:
        'Add the Agent Fabric AI Agents extension to your browser. Click the link below to open the Chrome Web Store. Then install the extension.',
      link: { url: CHROME_STORE_URL, label: 'Open Chrome Web Store' },
    },
    {
      title: 'Pin the extension to your toolbar',
      description:
        "Click Chrome's puzzle-piece icon in the toolbar, find Agent Fabric AI Agents, and click the pin icon next to it. Without pinning, the extension hides behind the Extensions menu.",
      descriptionNode: (
        <>
          ...
          in the toolbar, find Agent Fabric AI Agents, and{' '}
          <span className="inline-flex items-center gap-1">
            click the
    ...
    },
    {
      ...
      description: 'Open the extension and sign in with your Agent Fabric account.',
      hint: "Requires project membership — contact your admin if you can't sign in.",
    },
    {
      title: platformLabel
...
function buildHeader(platformLabel: string | undefined, isZendesk: boolean) {
  if (isZendesk) {
    return {
      ...
      description:
        'Install the Agent Fabric Support Copilot app from the Zendesk Marketplace to start using this app inside Zendesk tickets.',
    };
  }
  return {
    title: 'Install Support Copilot',
    description: platformLabel
      ? `Get the Agent Fabric AI Agents extension running alongside ${platformLabel} to start using this app.`
