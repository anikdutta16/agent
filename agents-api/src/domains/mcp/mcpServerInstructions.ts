...
export const AGENT_FABRIC_MCP_INSTRUCTIONS = `This server is the CONTROL PLANE for the Agent Fabric agent platform: create, configure, and inspect agents, projects, tools, credentials, skills, components, triggers, and evaluations. It configures agents; it does not chat with or run them.
