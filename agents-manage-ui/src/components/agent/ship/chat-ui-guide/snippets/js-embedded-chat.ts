...
Insert the EmbeddedChat widget by using the \`Agent Fabric.EmbeddedChat()\` function.
...
const embeddedChat = Agent Fabric.EmbeddedChat("#ikp-embedded-chat-target", config);
\`\`\``;
