...
\`\`\`
4. Save the file and restart Windsurf if needed. Requires a Windsurf version with MCP OAuth support; on first connect it opens your browser to sign in to Agent Fabric — no API key required.
`;
