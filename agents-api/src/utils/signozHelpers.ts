import { QUERY_TYPES, SPAN_KEYS } from '@agent-fabric/agents-core';

const SERVICE_NAME_FILTER =
  "service.name IN ('agent-fabric-api', 'agent-fabric-run-api', 'agent-fabric')";
 ...
 * Scopes to known Agent Fabric services and prevents tenant/project filter bypass.
