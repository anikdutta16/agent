import { contextConfig, fetchDefinition } from '@agent-fabric/agents-core';
import { z } from 'zod';
...
const projectDescription = fetchDefinition({
  ...
  fetchConfig: {
    url: 'https://api.management.localhost/graphql',
    body: {
      query: `
...
const agentFabricQaContext = contextConfig({
  id: 'agent-fabric-qa-context',
  contextVariables: {
    projectDescription,
  },
});

export { agentFabricQaContext, projectDescription };
