 ...
 * - @agent-fabric/agents-core/constants/schema-validation (API-level validation limits)
 * - @agent-fabric/agents-core/constants/execution-limits-shared (shared runtime limits)
 *
...
export const executionLimitsDefaults = {
  ...
  // Note: MCP connection/retry constants are defined in @agent-fabric/agents-core/constants/execution-limits-shared
