# @agent-fabric/agents-mcp

Model Context Protocol (MCP) Server for the *@agent-fabric/agents-mcp* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=@agent-fabric/agents-mcp&utm_campaign=mcp-typescript)
[![License: MIT](https://img.shields.io/badge/LICENSE_//_MIT-3b5bdb?style=for-the-badge&labelColor=eff6ff)](https://opensource.org/licenses/MIT)


<br /><br />
> [!IMPORTANT]
> This MCP Server is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/agent-fabric/agent-fabric). Delete this notice before publishing to a package manager.

<!-- Start Summary [summary] -->
## Summary

Agent Fabric API: REST API for the Agent Fabric.
<!-- End Summary [summary] -->

<!-- Start Table of Contents [toc] -->
## Table of Contents
<!-- $toc-max-depth=2 -->
* [@agent-fabric/agents-mcp](#agentFabricagents-mcp)
...
[![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](cursor://anysphere.cursor-deeplink/mcp/install?name=AgentFabricAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19)
...
```bash
claude mcp add AgentFabricAgents -- npx -y @agent-fabric/agents-mcp start --cookie-auth  --bearer-auth 
```
...
```bash
gemini mcp add AgentFabricAgents -- npx -y @agent-fabric/agents-mcp start --cookie-auth  --bearer-auth 
```
...
[![Install in VS Code](https://img.shields.io/badge/VS_Code-VS_Code?style=flat-square&label=Install%20AgentFabricAgents%20MCP&color=0098FF)](vscode://ms-vscode.vscode-mcp/install?name=AgentFabricAgents&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAaW5rZWVwL2FnZW50cy1tY3AiLCJzdGFydCIsIi0tY29va2llLWF1dGgiLCIiLCItLWJlYXJlci1hdXRoIiwiIl19)
...
```bash
npx @agent-fabric/agents-mcp start --cookie-auth  --bearer-auth 
```

For a full list of server arguments, run:

```
npx @agent-fabric/agents-mcp --help
```
...
```jsonc
{
  "mcpServers": {
    "AgentFabricAgents": {
      "command": "npx",
      "args": ["@agent-fabric/agents-mcp", "start", "--mode", "dynamic"],
...
### MCP Server Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@agent-fabric/agents-mcp&utm_campaign=mcp-typescript)
