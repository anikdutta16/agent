...
async function main(): Promise<void> {
  ...
  const githubRepo = process.env.GITHUB_REPOSITORY ?? 'agent-fabric/agents';
...
- Always include \`@agent-fabric/agents-core\` (constants are always updated)
- Only include \`@agent-fabric/agents-manage-ui\` if any models were added to or removed from the UI
- Only include \`@agent-fabric/agents-cli\` if any models were added to or removed from the CLI

Format:
---
"@agent-fabric/agents-core": patch
"@agent-fabric/agents-manage-ui": patch
"@agent-fabric/agents-cli": patch
---
