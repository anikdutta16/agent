...
p = d['ports']
print(f"export AGENT_FABRIC_AGENTS_MANAGE_DATABASE_URL='postgresql://appuser:password@localhost:{p['doltgres']}/agent_fabric'")
print(f"export AGENT_FABRIC_AGENTS_RUN_DATABASE_URL='postgresql://appuser:password@localhost:{p['postgres']}/agent_fabric'")
...
print(f"export AGENT_FABRIC_AGENTS_API_URL='http://localhost:{api}'")
print(f"export PUBLIC_AGENT_FABRIC_AGENTS_API_URL='http://localhost:{api}'")
print(f"export NEXT_PUBLIC_AGENT_FABRIC_AGENTS_API_URL='http://localhost:{api}'")
print(f"export AGENT_FABRIC_AGENTS_MANAGE_UI_URL='http://localhost:{ui}'")
print(f"export NEXT_PUBLIC_AGENT_FABRIC_AGENTS_MANAGE_UI_URL='http://localhost:{ui}'")
