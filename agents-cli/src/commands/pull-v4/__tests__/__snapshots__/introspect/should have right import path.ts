...
import { agentFabricManageMcpAndrewMikofalvyTool } from './tools/agent-fabric-manage-mcp-andrew-mikofalvy';
...
export const andrewTest = project({
  ...
  tools: () => [linearTool, googleCalendarMcpTool, notionTool, googleCalendarMcpTool1, agentFabricManageMcpAndrewMikofalvyTool],
