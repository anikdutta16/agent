import type { MessageContent, Part } from '@agent-fabric/agents-core';
import { normalizeMimeType } from '@agent-fabric/agents-core/constants/allowed-file-formats';
import {
...
} from '@agent-fabric/agents-core/external-fetch';
