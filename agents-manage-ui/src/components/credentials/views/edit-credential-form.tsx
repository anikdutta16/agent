...
import { CredentialStoreType } from '@agent-fabric/agents-core/client-exports';
...
export function EditCredentialForm({
  ...
  const forceCredentialType =
    PUBLIC_IS_AGENT_FABRIC_CLOUD_DEPLOYMENT === 'true' ? 'API Key' : undefined;
