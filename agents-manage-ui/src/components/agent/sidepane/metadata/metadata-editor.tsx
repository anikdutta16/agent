...
export const MetadataEditor: FC = () => {
  ...
  const baseUrl = PUBLIC_AGENT_FABRIC_AGENTS_API_URL;
  const {
    data: { canUse },
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        <FieldLabel
          ...
          tooltip="Use this endpoint to chat with your agent by appending /run/api/chat or connect it to the Agent Fabric widget via the baseUrl prop and specifying the appId. Supports streaming responses with the Vercel AI SDK data stream protocol."
        />
