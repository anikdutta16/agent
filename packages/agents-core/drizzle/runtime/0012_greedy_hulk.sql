...
CREATE TABLE IF NOT EXISTS "work_app_slack_user_mappings" (
	...
	"agentFabric_user_id" text NOT NULL,
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "work_app_slack_user_mappings" ADD CONSTRAINT "work_app_slack_user_mappings_agentFabric_user_id_user_id_fk" FOREIGN KEY ("agentFabric_user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "work_app_slack_user_mappings_user_idx" ON "work_app_slack_user_mappings" USING btree ("agentFabric_user_id");--> statement-breakpoint
