 ...
 *
 * Prerequisites:
 *   - AGENT_FABRIC_AGENTS_MANAGE_DATABASE_URL and AGENT_FABRIC_AGENTS_RUN_DATABASE_URL must be set.
...
const RUNTIME_DB_URL = process.env.AGENT_FABRIC_AGENTS_RUN_DATABASE_URL;
