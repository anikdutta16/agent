...
# The main logic lives at: https://github.com/agent-fabric/agents-optional-local-dev
#
# Usage:
...
if [ ! -d "$COMPANION_DIR" ]; then
  ...
  if git clone --quiet https://github.com/agent-fabric/agents-optional-local-dev.git "$COMPANION_DIR" 2>/dev/null; then
    echo "done."
  else
    echo "failed."
