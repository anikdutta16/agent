...
export function LinkedUsersSection() {
  ...
  const handleUnlinkUser = async () => {
    ...
    try {
      ...
      toast.success(
        `${userToUnlink.slackUsername || 'User'} has been unlinked from their Agent Fabric account`
      );
    } catch (err) {
    ...
    <>
      <Card className="shadow-none">
        <CardHeader className="pb-3">
          ...
          <CardDescription>Manage Slack users linked to Agent Fabric accounts</CardDescription>
        </CardHeader>
          ...
          {isLoading && linkedUsers.length === 0 ? (
            ...
            <div className="text-center py-6 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Users can run{' '}
                <code className="bg-muted px-1.5 py-0.5 rounded text-xs">/agent-fabric link</code>{' '}
                in Slack
              </p>
            </div>
          ) : (
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{userToUnlink?.slackUsername || 'this user'}</strong> from their Agent Fabric
              account?
              <br />
              <br />
