...
import { DEFAULT_NANGO_STORE_ID } from '@agent-fabric/agents-core/client-exports';
...
export function CredentialFormAgentFabricCloud({ onCreateCredential }: CredentialFormProps) {
