...
export const SPAN_KEYS = {
  ...
  // Cache intent (Agent Fabric namespace)
  ...
  // Custom `agent-fabric.*` namespace: these are self-emitted, interaction-rolled-up
  ...
  TTFT_MODEL_TOKEN: 'agent-fabric.agent.time_to_first_model_token',
  TTFT_VISIBLE_TOKEN: 'agent-fabric.agent.time_to_first_visible_token',
  TTFT_VISIBLE_PART: 'agent-fabric.agent.time_to_first_visible_part',
} as const;
