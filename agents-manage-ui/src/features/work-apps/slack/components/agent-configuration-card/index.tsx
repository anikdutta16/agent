    ...
    try {
      ...
      toast.success(
        grantAccess
          ...
          : 'Only users with an Agent Fabric project invite can use this agent'
      );
    } catch (error) {
      ...
      <Card className="shadow-none">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            The default agent for all <Badge variant="code">@Agent Fabric</Badge> mentions and{' '}
            <Badge variant="code">/agent-fabric</Badge> commands in{' '}
        ...
        <CardContent className="min-w-0 space-y-6">
          {!defaultAgent && channels.length > 0 && (
            <Alert variant="warning">
              ...
              <AlertDescription>
                Unless you configure a default agent for a channel, it won&apos;t respond to @Agent
                Fabric mentions or /agent-fabric commands.
              </AlertDescription>
            </Alert>
          )}
