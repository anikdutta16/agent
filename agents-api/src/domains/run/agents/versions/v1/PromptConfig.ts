import type { Artifact } from '@agent-fabric/agents-core';
import {
  type AssembleResult,
...
} from '@agent-fabric/agents-core/utils/json-schema-walk';
import {
  convertZodToJsonSchema,
  isZodSchema,
} from '@agent-fabric/agents-core/utils/schema-conversion';
...
- NEVER put literal values like "Agent Fabric" or "2023" - always use selectors like "metadata.company" or "founded_year"
...
- details_selector values are SELECTORS, not literal values. NEVER write a literal like "Agent Fabric"
