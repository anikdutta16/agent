 ...
 */
export const USER_AGENT = `agent-fabric-cli/${PACKAGE_VERSION} node/${process.versions.node} ${process.platform}/${process.arch}`;
 ...
 *
 * For the Agent Fabric CLI use case, this is sufficient as we only publish stable releases.
 */
...
export const PACKAGE_CHANGELOG =
  'https://github.com/agent-fabric/agents/blob/main/agents-cli/CHANGELOG.md';
