...
import type { DataPart, FilePart, MessageContent, Part, TextPart } from '@agent-fabric/agents-core';
import { getExtensionFromMimeType } from '@agent-fabric/agents-core/constants/allowed-file-formats';
import {
