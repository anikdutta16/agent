...
## Human contributors
- Full contribution guide: [https://localhost/community/contributing/overview](https://localhost/community/contributing/overview)
...
This repository is maintained by Agent Fabric and mirrored from our source tree. When you open a PR here:

1. Automation mirrors your PR into Agent Fabric's maintainer review flow.
2. The bridge workflow waits for Agent Fabric to approve its `agent-fabric-oss-sync` environment deployment before it runs, so the bot comment may not appear immediately.
...
- Raw file reference (rendered by GitHub): https://github.com/agent-fabric/agents/blob/main/AGENTS.md
