export const demoProject = {
  ...
  agents: {
    ...
    'kevin-mira-gong-transcripts': {
      ...
      description: null,
      defaultSubAgentId: 'agentFabricgong',
      subAgents: {
        agentFabricgong: {
          id: 'agentFabricgong',
          name: 'AgentFabricGong',
          description:
    ...
    'ashby-role-descriptions': {
      ...
      subAgents: {
        'role-description-generator': {
          ...
          description:
            'Fetches open roles from Ashby and generates updated role descriptions using Agent Fabric knowledge base',
          prompt: 'test',
          models: null,
          stopWhen: null,
          canTransferTo: [],
      ...
      tools: {
        c7kdb6dt92nyb80ub2rng: {
          ...
          name: 'Agent Fabric Enterprise Search MCP',
          description: null,
          config: {
            mcp: {
    ...
    'sales-agent': {
      ...
      subAgents: {
        ...
        'agent-fabric-positioning': {
          id: 'agent-fabric-positioning',
          name: 'Agent Fabric Positioning Specialist',
          description: 'Retrieves Agent Fabric positioning and differentiators from documentation',
          prompt: 'test',
          models: null,
          stopWhen: null,
          canTransferTo: [],
        ...
        'sales-coordinator': {
          ...
          stopWhen: null,
          canTransferTo: [],
          canDelegateTo: ['company-researcher', 'agent-fabric-positioning', 'competitor-analyst'],
          skills: [],
          dataComponents: [],
          artifactComponents: [],
          canUse: [],
    ...
    'sales-intelligence-agent': {
      ...
      subAgents: {
        ...
        'agent-fabric-positioning': {
          ...
          name: 'Agent Fabric Positioning Specialist',
          description:
            'Retrieves Agent Fabric positioning and differentiators from documentation (max 2 searches)',
          prompt: 'test',
          models: null,
          stopWhen: null,
          canTransferTo: [],
