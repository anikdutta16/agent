...
const ISSUER = 'agent-fabric-internal';

/**
 * Known internal services that can authenticate
 */
export const InternalServices = {
  AGENT_FABRIC_AGENTS_RUN_API: 'agent-fabric-run-api',
  AGENT_FABRIC_AGENTS_MANAGE_API: 'agent-fabric-manage-api',
  AGENT_FABRIC_AGENTS_EVAL_API: 'agent-fabric-eval-api',
} as const;
...
export interface InternalServiceTokenPayload {
  /** Issuer - always 'agent-fabric-internal' */
  iss: string;
