        ...
        <AgentFabricSidebarChat
          ...
          aiChatSettings={{
            ...
            headers: {
              ...
              ...(copilotAppId && { 'x-agent-fabric-app-id': copilotAppId }),
              ...
              ...(dynamicHeaders?.conversationId && {
                'x-agent-fabric-from-conversation-id': dynamicHeaders.conversationId,
              }),
              ...(dynamicHeaders?.messageId && {
                'x-agent-fabric-from-message-id': dynamicHeaders.messageId,
              }),
