          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex-1 flex items-center gap-2 min-h-10 px-3 py-2 border rounded-md bg-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
              ...
              {selectedMembers.length > 0 && (
                <ProjectRoleSelector
                  value={
                    selectedRole as import('@agent-fabric/agents-core/client-exports').ProjectRole
                  }
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {canEditPrincipal(principal) ? (
                    <ProjectRoleSelector
                      value={
                        principal.role as import('@agent-fabric/agents-core/client-exports').ProjectRole
                      }
                      onChange={(newRole) =>
