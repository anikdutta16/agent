...
generate_playground_keys() {
  ...
  echo "AGENT_FABRIC_AGENTS_TEMP_JWT_PRIVATE_KEY=$priv_b64"
  echo "AGENT_FABRIC_AGENTS_TEMP_JWT_PUBLIC_KEY=$pub_b64"
...
generate_copilot_keys() {
  ...
  echo "AGENT_FABRIC_COPILOT_JWT_PRIVATE_KEY=$priv_b64"
  echo "AGENT_FABRIC_COPILOT_JWT_KID=$kid"
  echo
