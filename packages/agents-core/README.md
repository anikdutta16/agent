...
Core database schema, types, validation, and data access layer for the Agent Fabric.
...
```bash
pnpm add @agent-fabric/agents-core
```
...
```typescript
import { createDatabaseClient } from '@agent-fabric/agents-core/data-access';
...
```typescript
import { getAgentById, createAgent, updateAgent } from '@agent-fabric/agents-core/data-access';
...
```typescript
import { AgentInsertSchema, AgentUpdateSchema } from '@agent-fabric/agents-core/validation';
...
import type { 
  ...
  TaskInsert,
  ConversationSelect 
} from '@agent-fabric/agents-core/validation';
...
When adding a new entity to the Agent Fabric, follow these steps to ensure proper integration across the schema, validation, and data access layers:
