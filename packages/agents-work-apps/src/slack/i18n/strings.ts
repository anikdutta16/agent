...
export const SlackStrings = {
  ...
  // Context block text
  context: {
    poweredBy: (agentName: string) => `Powered by *${agentName}* via Agent Fabric`,
  },

  // Usage hints
  usage: {
    mentionEmpty:
      '*Include a message to use your Agent Fabric agent:*\n\n' +
      '• `@Agent Fabric <message>` — Message the default agent (reply appears in a thread)\n' +
      '• `@Agent Fabric <message>` in a thread — Includes thread as context\n' +
      '• `@Agent Fabric` in a thread — Uses the full thread as context\n\n' +
      'Use `/agent-fabric help` for all available commands.',
  },
  ...
  errors: {
    ...
    noAgentConfigured:
      'No agent is configured for this workspace. Ask your admin to set up a default agent in the Agent Fabric dashboard.',
  },

  // Link prompt
  linkPrompt: {
    intro: "To get started, let's connect your Agent Fabric account with Slack.",
  },

  // Help message
  help: {
    title: 'Agent Fabric — How to Use',
    publicSection:
      '*Public* — visible to everyone in the channel\n\n' +
      '• `@Agent Fabric <message>` — Message the default agent in this channel\n' +
      '• `@Agent Fabric <message>` in a thread — Includes thread as context\n' +
      '• `@Agent Fabric` in a thread — Uses the full thread as context',
    slashSection:
      '*Slash Commands* — visible to everyone in the channel\n\n' +
      '• `/agent-fabric <message>` — Message the default agent in this channel\n' +
      '• `/agent-fabric` — Open the agent picker to choose an agent and write a prompt',
    otherCommands:
      '*Other Commands*\n\n' +
      '• `/agent-fabric status` — Check your connection and agent config\n' +
      '• `/agent-fabric link` / `/agent-fabric unlink` — Manage account connection\n' +
      '• `/agent-fabric help` — Show this message',
    docsLink: '<https://localhost/talk-to-your-agents/slack/overview|Learn more>',
  },
