...
TENANT_ID="default"
AGENT_FABRIC_AGENTS_API_URL="http://localhost:3002" # URL where agents-api is running
PUBLIC_AGENT_FABRIC_AGENTS_API_URL=http://localhost:3002 # URL where agents-api is running
