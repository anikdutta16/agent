...
export default defineConfig({
  ...
  env: {
    TEST_USER_EMAIL: process.env.AGENT_FABRIC_AGENTS_MANAGE_UI_USERNAME,
    TEST_USER_PASSWORD: process.env.AGENT_FABRIC_AGENTS_MANAGE_UI_PASSWORD,
    BYPASS_SECRET: process.env.AGENT_FABRIC_AGENTS_MANAGE_API_BYPASS_SECRET,
    API_URL: process.env.AGENT_FABRIC_AGENTS_API_URL || 'http://localhost:3002',
  },
  e2e: {
    video: true,
