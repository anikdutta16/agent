...
- 8a8b5b1: Fix context-window overflows after tools return large results by checking the current message size before the next model call.
  ...
  - @agent-fabric/agents-email@0.80.6
  - @agent-fabric/agents-mcp@0.80.6
  - @agent-fabric/agents-work-apps@0.80.6
...
- Updated dependencies [f160b29]
  ...
  - @agent-fabric/agents-work-apps@0.80.5
  - @agent-fabric/agents-email@0.80.5
  - @agent-fabric/agents-mcp@0.80.5
...
- 5bd4b90: Fix self-hosted playground startup so factory-created API apps register the playground public key from environment configuration.
  ...
  - @agent-fabric/agents-email@0.80.4
  - @agent-fabric/agents-mcp@0.80.4
  - @agent-fabric/agents-work-apps@0.80.4
...
- 9b83429: Remove link preview for slack outbound webhooks
  ...
  - @agent-fabric/agents-email@0.80.3
  - @agent-fabric/agents-mcp@0.80.3
  - @agent-fabric/agents-work-apps@0.80.3
...
- Updated dependencies [ac3476b]
  ...
  - @agent-fabric/agents-work-apps@0.80.2
  - @agent-fabric/agents-email@0.80.2
  - @agent-fabric/agents-mcp@0.80.2
...
- Updated dependencies [d94d837]
  ...
  - @agent-fabric/agents-work-apps@0.80.1
  - @agent-fabric/agents-email@0.80.1
  - @agent-fabric/agents-mcp@0.80.1
...
- Updated dependencies [c228447]
  ...
  - @agent-fabric/agents-work-apps@0.80.0
  - @agent-fabric/agents-email@0.80.0
  - @agent-fabric/agents-mcp@0.80.0
...
- Updated dependencies [1f02799]
  ...
  - @agent-fabric/agents-work-apps@0.79.1
  - @agent-fabric/agents-email@0.79.1
  - @agent-fabric/agents-mcp@0.79.1
...
- Updated dependencies [356084b]
  ...
  - @agent-fabric/agents-work-apps@0.79.0
  - @agent-fabric/agents-email@0.79.0
  - @agent-fabric/agents-mcp@0.79.0
...
- Updated dependencies [78594e9]
  ...
  - @agent-fabric/agents-work-apps@0.78.5
  - @agent-fabric/agents-email@0.78.5
  - @agent-fabric/agents-mcp@0.78.5
...
- Updated dependencies [673f4c6]
  ...
  - @agent-fabric/agents-work-apps@0.78.4
  - @agent-fabric/agents-email@0.78.4
  - @agent-fabric/agents-mcp@0.78.4
...
- 10b84ca: Return a clear 403 instead of a misleading 'Project not found' 404 when a user can view a project but lacks use/edit permission
  ...
  - @agent-fabric/agents-email@0.78.3
  - @agent-fabric/agents-mcp@0.78.3
  - @agent-fabric/agents-work-apps@0.78.3
...
- Updated dependencies [8b0bc17]
  ...
  - @agent-fabric/agents-work-apps@0.78.1
  - @agent-fabric/agents-email@0.78.1
  - @agent-fabric/agents-mcp@0.78.1
...
- Updated dependencies [252efd9]
  ...
  - @agent-fabric/agents-work-apps@0.78.0
  - @agent-fabric/agents-email@0.78.0
  - @agent-fabric/agents-mcp@0.78.0
...
- b4de6bc: Fix the bot-protection challenge proxy returning 502 on every POST. The challenge/verify proxy handlers read the request body off `c.req.raw` (the underlying stream), which a preceding middleware had already consumed via `c.req.json()` — the second read threw "Body is unusable: Body has already been read" and was masked as a 502. This broke every HIS challenge submission and verification for anonymous sessions across all embedded widget versions. Handlers now read the body via Hono's cache-safe `c.req.text()` and pass it to the proxy helpers.
  ...
  - @agent-fabric/agents-email@0.77.1
  - @agent-fabric/agents-mcp@0.77.1
  - @agent-fabric/agents-work-apps@0.77.1
...
- @agent-fabric/agents-email@0.77.0
- @agent-fabric/agents-mcp@0.77.0
- @agent-fabric/agents-work-apps@0.77.0

## 0.76.0

### Patch Changes

- b29a931: Make transient external-file download failures and unsupported-MIME errors non-fatal in the chat-message upload pipeline. A single 404, timeout, DNS failure, or `image/gif`-bytes detection on one inline image no longer aborts the entire chat request — the affected file is logged and dropped via the existing worker-drop path; remaining files and the message continue through. Real security guards (private-IP/SSRF, embedded credentials, disallowed schemes/ports) remain fatal. Internal imports updated to consume `downloadExternalFile`, the error taxonomy, and `text-document-attachments` from their new `@agent-fabric/agents-core/external-fetch` and `@agent-fabric/agents-core/text-attachments` subpaths.
...
- Updated dependencies [7efbf18]
  ...
  - @agent-fabric/agents-work-apps@0.76.0
  - @agent-fabric/agents-email@0.76.0
  - @agent-fabric/agents-mcp@0.76.0
...
- cbae12e: Hide internal compressed tool_result artifacts from end-user conversation surfaces while keeping them model-facing
  ...
  - @agent-fabric/agents-email@0.75.4
  - @agent-fabric/agents-mcp@0.75.4
  - @agent-fabric/agents-work-apps@0.75.4
...
- Updated dependencies [c9072d5]
  ...
  - @agent-fabric/agents-work-apps@0.75.3
  - @agent-fabric/agents-email@0.75.3
  - @agent-fabric/agents-mcp@0.75.3
...
- 452bbef: Remove per-request bot-protection scoring from authenticated requests. Bot protection now gates anonymous-session creation only; authenticated requests rely on their app-signed JWT and ignore the challenge header. This fixes authenticated widget builds that send a legacy challenge-header shape being rejected with a 400 "Bot protection challenge solution is invalid" error.
  ...
  - @agent-fabric/agents-email@0.75.2
  - @agent-fabric/agents-mcp@0.75.2
  - @agent-fabric/agents-work-apps@0.75.2
...
- Updated dependencies [2042ce9]
  ...
  - @agent-fabric/agents-work-apps@0.75.1
  - @agent-fabric/agents-email@0.75.1
  - @agent-fabric/agents-mcp@0.75.1
...
- db2be2f: Add ALTCHA Sentinel as the primary widget bot-protection path; preserve the legacy local-PoW endpoint as a Sentinel-backed compatibility shim.
  ...
  **New env vars:**
  - v2 (Sentinel HIS): `AGENT_FABRIC_SENTINEL_API_KEY_ID`, `AGENT_FABRIC_SENTINEL_API_KEY_SECRET`, `AGENT_FABRIC_SENTINEL_BASE_URL` — all three required together, or all unset to disable.
  - v1 (legacy PoW compat): `AGENT_FABRIC_SENTINEL_V1_API_KEY_ID`, `AGENT_FABRIC_SENTINEL_V1_API_KEY_SECRET` — both required together; reuses `AGENT_FABRIC_SENTINEL_BASE_URL`.

  Enabling v1 alongside v2 is a migration-only posture: clients choose the verification path by envelope shape, and v1 has no replay protection and no HIS scoring. Disable `AGENT_FABRIC_SENTINEL_V1_*` once legacy widget traffic drops to ~0.
...
- Updated dependencies [db2be2f]
  ...
  - @agent-fabric/agents-work-apps@0.75.0
  - @agent-fabric/agents-email@0.75.0
  - @agent-fabric/agents-mcp@0.75.0
...
- Updated dependencies [1521dcc]
  ...
  - @agent-fabric/agents-work-apps@0.74.4
  - @agent-fabric/agents-email@0.74.4
  - @agent-fabric/agents-mcp@0.74.4

## 0.74.3

### Patch Changes

- d6c3176: Enable Anthropic prompt caching by default at the main agent generation call (gateway and direct mode), gated by the new AGENT_FABRIC_PROMPT_CACHING_ENABLED env var, and stabilize the cacheable system-prompt prefix across turns
...
- Updated dependencies [d6c3176]
  ...
  - @agent-fabric/agents-work-apps@0.74.3
  - @agent-fabric/agents-email@0.74.3
  - @agent-fabric/agents-mcp@0.74.3
...
- Updated dependencies [ba25590]
  ...
  - @agent-fabric/agents-work-apps@0.74.2
  - @agent-fabric/agents-email@0.74.2
  - @agent-fabric/agents-mcp@0.74.2
...
- d5e2002: Fix ArtifactCreate* structured-output validation failures on Haiku by dropping two redundant prop fields. `props.type` is now derived from the component name (which already encodes it as the `ArtifactCreate*<type>`suffix), and`props.id`is renamed to`props.artifact_id`to eliminate visual collision with the outer`id` field. Both fields were server-internal — never streamed to clients, never persisted under those names — so this is a non-breaking change.
  ...
  - @agent-fabric/agents-email@0.74.1
  - @agent-fabric/agents-mcp@0.74.1
  - @agent-fabric/agents-work-apps@0.74.1
...
- Updated dependencies [1af568e]
  ...
  - @agent-fabric/agents-work-apps@0.74.0
  - @agent-fabric/agents-email@0.74.0
  - @agent-fabric/agents-mcp@0.74.0
...
- Updated dependencies [cbc947d]
  - @agent-fabric/agents-work-apps@0.73.5
  - @agent-fabric/agents-core@0.73.5
  - @agent-fabric/agents-email@0.73.5
  - @agent-fabric/agents-mcp@0.73.5
...
- Updated dependencies [4f7c661]
  ...
  - @agent-fabric/agents-work-apps@0.73.4
  - @agent-fabric/agents-email@0.73.4
  - @agent-fabric/agents-mcp@0.73.4
...
- 1cc72e2: Honor client-supplied user message ids on chat routes (`/run/api/chat` and `/run/api/chat/completions`) so analytics events fired client-side correlate to the persisted `messages.id` row
  ...
  - @agent-fabric/agents-email@0.73.3
  - @agent-fabric/agents-mcp@0.73.3
  - @agent-fabric/agents-work-apps@0.73.3
...
- @agent-fabric/agents-email@0.73.2
- @agent-fabric/agents-mcp@0.73.2
- @agent-fabric/agents-work-apps@0.73.2
...
- Updated dependencies [f069c82]
  ...
  - @agent-fabric/agents-work-apps@0.73.1
  - @agent-fabric/agents-email@0.73.1
  - @agent-fabric/agents-mcp@0.73.1
...
- Updated dependencies [ed76d93]
  ...
  - @agent-fabric/agents-work-apps@0.73.0
  - @agent-fabric/agents-email@0.73.0
  - @agent-fabric/agents-mcp@0.73.0
...
- @agent-fabric/agents-email@0.72.2
- @agent-fabric/agents-mcp@0.72.2
- @agent-fabric/agents-work-apps@0.72.2
...
- Updated dependencies [52e099d]
  ...
  - @agent-fabric/agents-work-apps@0.72.1
  - @agent-fabric/agents-email@0.72.1
  - @agent-fabric/agents-mcp@0.72.1
...
- Updated dependencies [4a0d963]
  ...
  - @agent-fabric/agents-work-apps@0.72.0
  - @agent-fabric/agents-email@0.72.0
  - @agent-fabric/agents-mcp@0.72.0
...
- Updated dependencies [c3cbdbf]
  ...
  - @agent-fabric/agents-work-apps@0.71.0
  - @agent-fabric/agents-email@0.71.0
  - @agent-fabric/agents-mcp@0.71.0
...
- Updated dependencies [3f9262b]
  - @agent-fabric/agents-work-apps@0.70.8
  - @agent-fabric/agents-core@0.70.8
  - @agent-fabric/agents-email@0.70.8
  - @agent-fabric/agents-mcp@0.70.8
...
- Updated dependencies [2e5c421]
  ...
  - @agent-fabric/agents-work-apps@0.70.7
  - @agent-fabric/agents-email@0.70.7
  - @agent-fabric/agents-mcp@0.70.7
...
- @agent-fabric/agents-email@0.70.6
- @agent-fabric/agents-mcp@0.70.6
- @agent-fabric/agents-work-apps@0.70.6
...
- Updated dependencies [903b1ef]
  ...
  - @agent-fabric/agents-work-apps@0.70.5
  - @agent-fabric/agents-email@0.70.5
  - @agent-fabric/agents-mcp@0.70.5
...
- Updated dependencies [d96e872]
  ...
  - @agent-fabric/agents-work-apps@0.70.4
  - @agent-fabric/agents-email@0.70.4
  - @agent-fabric/agents-mcp@0.70.4
...
- 16b4daa: Filter tenant-wide apps list by caller's project use permissions to prevent cross-project enumeration
  ...
  - @agent-fabric/agents-email@0.70.3
  - @agent-fabric/agents-mcp@0.70.3
  - @agent-fabric/agents-work-apps@0.70.3
...
- Updated dependencies [a4d2360]
  ...
  - @agent-fabric/agents-work-apps@0.70.2
  - @agent-fabric/agents-email@0.70.2
  - @agent-fabric/agents-mcp@0.70.2
...
- fbfeb6d: Import CSV functionality for datasets and rerun test suite runs
  ...
  - @agent-fabric/agents-email@0.70.1
  - @agent-fabric/agents-mcp@0.70.1
  - @agent-fabric/agents-work-apps@0.70.1
...
- Updated dependencies [1570c2a]
  ...
  - @agent-fabric/agents-work-apps@0.70.0
  - @agent-fabric/agents-email@0.70.0
  - @agent-fabric/agents-mcp@0.70.0
...
- Updated dependencies [a6bd5ec]
  ...
  - @agent-fabric/agents-work-apps@0.69.1
  - @agent-fabric/agents-email@0.69.1
  - @agent-fabric/agents-mcp@0.69.1
...
- 52d0831: Resolve `{{$conversation.id}}` in agent prompts to the current conversation ID. Works with or without a `contextConfig`; propagates through A2A delegation so a child sub-agent resolves to the parent's (user-initiated) conversation ID. Agents whose prompts don't reference `{{$conversation.` see no behavior change.
  ...
  **Note for external A2A callers:** A2A JSON-RPC clients that bypass Agent Fabric's delegation tool must pass `contextId` in the message body for the variable to resolve to the user's overarching conversation. Without it, the handler falls back to `generateId()` and the variable resolves to an unrelated synthetic ID.
...
- Updated dependencies [32bce4f]
  ...
  - @agent-fabric/agents-work-apps@0.69.0
  - @agent-fabric/agents-email@0.69.0
  - @agent-fabric/agents-mcp@0.69.0
...
- Updated dependencies [7438f76]
  - @agent-fabric/agents-work-apps@0.68.4
  - @agent-fabric/agents-core@0.68.4
  - @agent-fabric/agents-email@0.68.4
  - @agent-fabric/agents-mcp@0.68.4
...
- Updated dependencies [e8776f5]
  ...
  - @agent-fabric/agents-work-apps@0.68.3
  - @agent-fabric/agents-email@0.68.3
  - @agent-fabric/agents-mcp@0.68.3
...
- Updated dependencies [4e0fd65]
  ...
  - @agent-fabric/agents-work-apps@0.68.2
  - @agent-fabric/agents-email@0.68.2
  - @agent-fabric/agents-mcp@0.68.2
...
- Updated dependencies [a074f63]
  - @agent-fabric/agents-mcp@0.68.1
  - @agent-fabric/agents-core@0.68.1
  - @agent-fabric/agents-email@0.68.1
  - @agent-fabric/agents-work-apps@0.68.1
...
- Updated dependencies [d1e18a8]
  ...
  - @agent-fabric/agents-work-apps@0.68.0
  - @agent-fabric/agents-email@0.68.0
  - @agent-fabric/agents-mcp@0.68.0
...
- @agent-fabric/agents-email@0.67.4
- @agent-fabric/agents-mcp@0.67.4
- @agent-fabric/agents-work-apps@0.67.4
...
- ab65543: Fix text file artifacts being returned as base64-encoded file parts instead of decoded text content
  ...
  - @agent-fabric/agents-email@0.67.3
  - @agent-fabric/agents-mcp@0.67.3
  - @agent-fabric/agents-work-apps@0.67.3
...
- @agent-fabric/agents-email@0.67.2
- @agent-fabric/agents-mcp@0.67.2
- @agent-fabric/agents-work-apps@0.67.2
...
- ad12123: Skip artifact creation for text document attachments that are already inlined into the prompt
  ...
  - @agent-fabric/agents-email@0.67.1
  - @agent-fabric/agents-mcp@0.67.1
  - @agent-fabric/agents-work-apps@0.67.1
...
- Updated dependencies [757ac77]
  ...
  - @agent-fabric/agents-work-apps@0.67.0
  - @agent-fabric/agents-email@0.67.0
  - @agent-fabric/agents-mcp@0.67.0
...
- @agent-fabric/agents-email@0.66.1
- @agent-fabric/agents-mcp@0.66.1
- @agent-fabric/agents-work-apps@0.66.1
...
- Updated dependencies [4d0169b]
  ...
  - @agent-fabric/agents-work-apps@0.66.0
  - @agent-fabric/agents-email@0.66.0
  - @agent-fabric/agents-mcp@0.66.0
...
- Updated dependencies [93eb31e]
  - @agent-fabric/agents-mcp@0.65.2
  - @agent-fabric/agents-work-apps@0.65.2
  - @agent-fabric/agents-core@0.65.2
  - @agent-fabric/agents-email@0.65.2
...
- Updated dependencies [dbee04b]
  ...
  - @agent-fabric/agents-work-apps@0.65.1
  - @agent-fabric/agents-email@0.65.1
  - @agent-fabric/agents-mcp@0.65.1
...
- Updated dependencies [e332202]
  ...
  - @agent-fabric/agents-work-apps@0.65.0
  - @agent-fabric/agents-email@0.65.0
  - @agent-fabric/agents-mcp@0.65.0
...
- @agent-fabric/agents-email@0.64.10
- @agent-fabric/agents-mcp@0.64.10
- @agent-fabric/agents-work-apps@0.64.10
...
- @agent-fabric/agents-email@0.64.9
- @agent-fabric/agents-mcp@0.64.9
- @agent-fabric/agents-work-apps@0.64.9
...
- @agent-fabric/agents-email@0.64.8
- @agent-fabric/agents-mcp@0.64.8
- @agent-fabric/agents-work-apps@0.64.8
...
- @agent-fabric/agents-email@0.64.7
- @agent-fabric/agents-mcp@0.64.7
- @agent-fabric/agents-work-apps@0.64.7
...
- Updated dependencies [6fddd34]
  ...
  - @agent-fabric/agents-work-apps@0.64.6
  - @agent-fabric/agents-email@0.64.6
  - @agent-fabric/agents-mcp@0.64.6
...
- Updated dependencies [e91d67b]
  ...
  - @agent-fabric/agents-work-apps@0.64.5
  - @agent-fabric/agents-email@0.64.5
  - @agent-fabric/agents-mcp@0.64.5
...
- @agent-fabric/agents-email@0.64.4
- @agent-fabric/agents-mcp@0.64.4
- @agent-fabric/agents-work-apps@0.64.4
...
- Updated dependencies [4ace590]
  ...
  - @agent-fabric/agents-work-apps@0.64.3
  - @agent-fabric/agents-email@0.64.3
  - @agent-fabric/agents-mcp@0.64.3
...
- Updated dependencies [f099221]
  ...
  - @agent-fabric/agents-work-apps@0.64.2
  - @agent-fabric/agents-email@0.64.2
  - @agent-fabric/agents-mcp@0.64.2
...
- Updated dependencies [a26343d]
  - @agent-fabric/agents-work-apps@0.64.1
  - @agent-fabric/agents-core@0.64.1
  - @agent-fabric/agents-email@0.64.1
  - @agent-fabric/agents-mcp@0.64.1
...
- Updated dependencies [abc3b5d]
  ...
  - @agent-fabric/agents-mcp@0.64.0
  - @agent-fabric/agents-work-apps@0.64.0
  - @agent-fabric/agents-email@0.64.0
...
- cfcdc30: Fix anonymous auth path accepting arbitrary tenant/project headers for global apps
  ...
  - @agent-fabric/agents-email@0.63.3
  - @agent-fabric/agents-mcp@0.63.3
  - @agent-fabric/agents-work-apps@0.63.3
...
- Updated dependencies [dc818c0]
  ...
  - @agent-fabric/agents-work-apps@0.63.2
  - @agent-fabric/agents-email@0.63.2
  - @agent-fabric/agents-mcp@0.63.2
...
- 7dc35b6: Set `initiatedBy` in execution context metadata for app credential auth paths so user-scoped MCP credentials (e.g. Linear OAuth) are resolved correctly
  ...
  - @agent-fabric/agents-email@0.63.1
  - @agent-fabric/agents-mcp@0.63.1
  - @agent-fabric/agents-work-apps@0.63.1
...
- Updated dependencies [0f77d00]
  ...
  - @agent-fabric/agents-work-apps@0.63.0
  - @agent-fabric/agents-email@0.63.0
  - @agent-fabric/agents-mcp@0.63.0
...
- Updated dependencies [6332134]
  ...
  - @agent-fabric/agents-email@0.62.2
  - @agent-fabric/agents-work-apps@0.62.2
  - @agent-fabric/agents-mcp@0.62.2
...
- 8b74409: Add inline text document attachments to the run chat APIs for `text/plain`, `text/markdown`, `text/html`, `text/csv`, `text/x-log`, and `application/json` while keeping remote URLs limited to PDFs. Persist text attachments as blob-backed file parts and replay them into model input as XML-tagged text blocks.
  ...
  - @agent-fabric/agents-email@0.62.1
  - @agent-fabric/agents-mcp@0.62.1
  - @agent-fabric/agents-work-apps@0.62.1
...
- Updated dependencies [ce9c516]
  ...
  - @agent-fabric/agents-work-apps@0.62.0
  - @agent-fabric/agents-email@0.62.0
  - @agent-fabric/agents-mcp@0.62.0
...
- Updated dependencies [f4a9c69]
  ...
  - @agent-fabric/agents-work-apps@0.61.0
  - @agent-fabric/agents-email@0.61.0
  - @agent-fabric/agents-mcp@0.61.0
...
- Updated dependencies [b1199eb]
  ...
  - @agent-fabric/agents-work-apps@0.60.0
  - @agent-fabric/agents-email@0.60.0
  - @agent-fabric/agents-mcp@0.60.0
...
- Updated dependencies [99b5edf]
  ...
  - @agent-fabric/agents-work-apps@0.59.4
  - @agent-fabric/agents-email@0.59.4
  - @agent-fabric/agents-mcp@0.59.4
...
- Updated dependencies [6ca8164]
  ...
  - @agent-fabric/agents-work-apps@0.59.3
  - @agent-fabric/agents-email@0.59.3
  - @agent-fabric/agents-mcp@0.59.3
...
- c6bcd18: Fix fetchTraceFromSigNoz method in the EvaluationService
  ...
  - @agent-fabric/agents-email@0.59.2
  - @agent-fabric/agents-mcp@0.59.2
  - @agent-fabric/agents-work-apps@0.59.2
...
- Updated dependencies [bab9603]
  ...
  - @agent-fabric/agents-work-apps@0.59.1
  - @agent-fabric/agents-email@0.59.1
  - @agent-fabric/agents-mcp@0.59.1
...
- Updated dependencies [b1e6ced]
  ...
  - @agent-fabric/agents-work-apps@0.59.0
  - @agent-fabric/agents-email@0.59.0
  - @agent-fabric/agents-mcp@0.59.0
...
- @agent-fabric/agents-email@0.58.21
- @agent-fabric/agents-mcp@0.58.21
- @agent-fabric/agents-work-apps@0.58.21
...
- Updated dependencies [b4baf66]
  ...
  - @agent-fabric/agents-work-apps@0.58.20
  - @agent-fabric/agents-email@0.58.20
  - @agent-fabric/agents-mcp@0.58.20
...
- Updated dependencies [9660fc2]
  ...
  - @agent-fabric/agents-work-apps@0.58.19
  - @agent-fabric/agents-email@0.58.19
  - @agent-fabric/agents-mcp@0.58.19
...
- 128845e: Fix message ID mismatch between server and client for feedback records
  ...
  - @agent-fabric/agents-email@0.58.18
  - @agent-fabric/agents-mcp@0.58.18
  - @agent-fabric/agents-work-apps@0.58.18
...
- f94a089: service name filtering added to signoz queries
  ...
  - @agent-fabric/agents-email@0.58.17
  - @agent-fabric/agents-mcp@0.58.17
  - @agent-fabric/agents-work-apps@0.58.17
...
- Updated dependencies [5065552]
  ...
  - @agent-fabric/agents-work-apps@0.58.16
  - @agent-fabric/agents-email@0.58.16
  - @agent-fabric/agents-mcp@0.58.16
...
- 4b46b9e: Updating Signoz service name from agent-fabric-run-api to agent-fabric-api
...
- Updated dependencies [abaefda]
  - @agent-fabric/agents-work-apps@0.58.15
  - @agent-fabric/agents-core@0.58.15
  - @agent-fabric/agents-email@0.58.15
  - @agent-fabric/agents-mcp@0.58.15
...
- d147f0e: Fix agent create/update handlers to forward all schema fields (models, statusUpdates, prompt, stopWhen)
  ...
  - @agent-fabric/agents-email@0.58.14
  - @agent-fabric/agents-mcp@0.58.14
  - @agent-fabric/agents-work-apps@0.58.14
...
- 9ed6710: Fix user ID forwarding during agent delegation
  ...
  - @agent-fabric/agents-email@0.58.13
  - @agent-fabric/agents-mcp@0.58.13
  - @agent-fabric/agents-work-apps@0.58.13
...
- Updated dependencies [ad8a7cd]
  ...
  - @agent-fabric/agents-work-apps@0.58.12
  - @agent-fabric/agents-email@0.58.12
  - @agent-fabric/agents-mcp@0.58.12
...
- Updated dependencies [c87dc3e]
  ...
  - @agent-fabric/agents-work-apps@0.58.11
  - @agent-fabric/agents-email@0.58.11
  - @agent-fabric/agents-mcp@0.58.11
...
- Updated dependencies [41af59e]
  ...
  - @agent-fabric/agents-work-apps@0.58.10
  - @agent-fabric/agents-email@0.58.10
  - @agent-fabric/agents-mcp@0.58.10
...
- Updated dependencies [4816f02]
  ...
  - @agent-fabric/agents-work-apps@0.58.9
  - @agent-fabric/agents-email@0.58.9
  - @agent-fabric/agents-mcp@0.58.9
...
- Updated dependencies [e89948d]
  ...
  - @agent-fabric/agents-work-apps@0.58.8
  - @agent-fabric/agents-email@0.58.8
  - @agent-fabric/agents-mcp@0.58.8
...
- b1b440a: daisy chain trigger
  ...
  - @agent-fabric/agents-email@0.58.7
  - @agent-fabric/agents-mcp@0.58.7
  - @agent-fabric/agents-work-apps@0.58.7
...
- Updated dependencies [16e5e8d]
  - @agent-fabric/agents-work-apps@0.58.6
  - @agent-fabric/agents-core@0.58.6
  - @agent-fabric/agents-email@0.58.6
  - @agent-fabric/agents-mcp@0.58.6
...
- @agent-fabric/agents-email@0.58.5
- @agent-fabric/agents-mcp@0.58.5
- @agent-fabric/agents-work-apps@0.58.5
...
- Updated dependencies [2d6ec44]
  ...
  - @agent-fabric/agents-work-apps@0.58.4
  - @agent-fabric/agents-email@0.58.4
  - @agent-fabric/agents-mcp@0.58.4
...
- Updated dependencies [0714ac6]
  - @agent-fabric/agents-work-apps@0.58.3
  - @agent-fabric/agents-core@0.58.3
  - @agent-fabric/agents-email@0.58.3
  - @agent-fabric/agents-mcp@0.58.3
...
- Updated dependencies [eb5b16f]
  ...
  - @agent-fabric/agents-work-apps@0.58.2
  - @agent-fabric/agents-email@0.58.2
  - @agent-fabric/agents-mcp@0.58.2
...
- 9876f88: Add Sentry capability configuration to agents-api and modify create-agents template
  ...
  - @agent-fabric/agents-email@0.58.1
  - @agent-fabric/agents-mcp@0.58.1
  - @agent-fabric/agents-work-apps@0.58.1
...
- Updated dependencies [3d88636]
  ...
  - @agent-fabric/agents-work-apps@0.58.0
  - @agent-fabric/agents-email@0.58.0
  - @agent-fabric/agents-mcp@0.58.0
...
- Updated dependencies [95e2477]
  ...
  - @agent-fabric/agents-work-apps@0.57.0
  - @agent-fabric/agents-email@0.57.0
  - @agent-fabric/agents-mcp@0.57.0
...
- @agent-fabric/agents-email@0.56.2
- @agent-fabric/agents-mcp@0.56.2
- @agent-fabric/agents-work-apps@0.56.2

## 0.56.1

### Patch Changes

- c620c02: Add copilot bypass for tenant/project access checks when AGENTFABRIC*COPILOT*\* env vars are configured
- a175379: Add hasErrors filter to traces page and fix agent.name span attribute
  - @agent-fabric/agents-core@0.56.1
  - @agent-fabric/agents-email@0.56.1
  - @agent-fabric/agents-mcp@0.56.1
  - @agent-fabric/agents-work-apps@0.56.1
...
- Updated dependencies [06e8c12]
  ...
  - @agent-fabric/agents-work-apps@0.56.0
  - @agent-fabric/agents-email@0.56.0
  - @agent-fabric/agents-mcp@0.56.0
...
- @agent-fabric/agents-email@0.55.3
- @agent-fabric/agents-mcp@0.55.3
- @agent-fabric/agents-work-apps@0.55.3
...
- Updated dependencies [4414e25]
  ...
  - @agent-fabric/agents-work-apps@0.55.2
  - @agent-fabric/agents-email@0.55.2
  - @agent-fabric/agents-mcp@0.55.2
...
- 55eb8cb: debug 500 signoz errors and reduce timerange query
  ...
  - @agent-fabric/agents-mcp@0.55.1
  - @agent-fabric/agents-work-apps@0.55.1
...
- Updated dependencies [08d678d]
  ...
  - @agent-fabric/agents-work-apps@0.55.0
  - @agent-fabric/agents-mcp@0.55.0
...
- Updated dependencies [addc4a0]
  ...
  - @agent-fabric/agents-work-apps@0.54.0
  - @agent-fabric/agents-mcp@0.54.0
...
- Updated dependencies [23b6b48]
  ...
  - @agent-fabric/agents-work-apps@0.53.13
  - @agent-fabric/agents-mcp@0.53.13

## 0.53.12

### Patch Changes

- 6762a28: Fix Agent Card 400 error caused by system identifiers in x-agent-fabric-run-as-user-id header (PRD-6187)
  - @agent-fabric/agents-core@0.53.12
  - @agent-fabric/agents-mcp@0.53.12
  - @agent-fabric/agents-work-apps@0.53.12
...
- 5061d64: Add blob storage abstraction (S3 and Vercel Blob providers)
  ...
  - @agent-fabric/agents-mcp@0.53.11
  - @agent-fabric/agents-work-apps@0.53.11
...
- Updated dependencies [7299f4a]
  ...
  - @agent-fabric/agents-work-apps@0.53.10
  - @agent-fabric/agents-mcp@0.53.10
...
- Updated dependencies [603d7a8]
  ...
  - @agent-fabric/agents-work-apps@0.53.9
  - @agent-fabric/agents-mcp@0.53.9
...
- Updated dependencies [4761e1f]
  - @agent-fabric/agents-work-apps@0.53.8
  - @agent-fabric/agents-core@0.53.8
  - @agent-fabric/agents-mcp@0.53.8
...
- Updated dependencies [54985c0]
  ...
  - @agent-fabric/agents-work-apps@0.53.7
  - @agent-fabric/agents-mcp@0.53.7
...
- @agent-fabric/agents-mcp@0.53.6
- @agent-fabric/agents-work-apps@0.53.6
...
- Updated dependencies [7abd1bd]
  - @agent-fabric/agents-work-apps@0.53.5
  - @agent-fabric/agents-core@0.53.5
  - @agent-fabric/agents-mcp@0.53.5
...
- Updated dependencies [be72c29]
  - @agent-fabric/agents-work-apps@0.53.4
  - @agent-fabric/agents-core@0.53.4
  - @agent-fabric/agents-mcp@0.53.4
...
- Updated dependencies [f7e47ab]
  - @agent-fabric/agents-work-apps@0.53.3
  - @agent-fabric/agents-core@0.53.3
  - @agent-fabric/agents-mcp@0.53.3
...
- @agent-fabric/agents-mcp@0.53.2
- @agent-fabric/agents-work-apps@0.53.2
...
- Updated dependencies [c4d8a7b]
  - @agent-fabric/agents-work-apps@0.53.1
  - @agent-fabric/agents-core@0.53.1
  - @agent-fabric/agents-mcp@0.53.1
...
- Updated dependencies [4d4fa33]
  - @agent-fabric/agents-work-apps@0.53.0
  - @agent-fabric/agents-core@0.53.0
  - @agent-fabric/agents-mcp@0.53.0
...
- Updated dependencies [520e4f0]
  ...
  - @agent-fabric/agents-work-apps@0.52.0
  - @agent-fabric/agents-mcp@0.52.0
...
- Updated dependencies [fe36caa]
  - @agent-fabric/agents-work-apps@0.51.0
  - @agent-fabric/agents-core@0.51.0
  - @agent-fabric/agents-mcp@0.51.0
...
- 51bb2f6: remove noisy instrumentation in agents api
  ...
  - @agent-fabric/agents-mcp@0.50.6
  - @agent-fabric/agents-work-apps@0.50.6
...
- Updated dependencies [56fd821]
  ...
  - @agent-fabric/agents-work-apps@0.50.5
  - @agent-fabric/agents-mcp@0.50.5
...
- Updated dependencies [e623802]
  ...
  - @agent-fabric/agents-work-apps@0.50.4
  - @agent-fabric/agents-mcp@0.50.4
...
- Updated dependencies [0011c4b]
  - @agent-fabric/agents-work-apps@0.50.3
  - @agent-fabric/agents-core@0.50.3
  - @agent-fabric/agents-mcp@0.50.3
...
- Updated dependencies [becf184]
  ...
  - @agent-fabric/agents-work-apps@0.50.2
  - @agent-fabric/agents-mcp@0.50.2
...
- Updated dependencies [6d31fe6]
  ...
  - @agent-fabric/agents-work-apps@0.50.1
  - @agent-fabric/agents-mcp@0.50.1
...
- Updated dependencies [5bd9461]
  - @agent-fabric/agents-work-apps@0.50.0
  - @agent-fabric/agents-core@0.50.0
  - @agent-fabric/agents-mcp@0.50.0
...
- Updated dependencies [3f556b7]
  - @agent-fabric/agents-work-apps@0.49.0
  - @agent-fabric/agents-core@0.49.0
  - @agent-fabric/agents-mcp@0.49.0
...
- Updated dependencies [3532557]
  ...
  - @agent-fabric/agents-work-apps@0.48.7
  - @agent-fabric/agents-mcp@0.48.7
...
- Updated dependencies [2e8d956]
  ...
  - @agent-fabric/agents-work-apps@0.48.6
  - @agent-fabric/agents-mcp@0.48.6
...
- Updated dependencies [f39f8b0]
  - @agent-fabric/agents-work-apps@0.48.5
  - @agent-fabric/agents-core@0.48.5
  - @agent-fabric/agents-manage-mcp@0.48.5
  - @agent-fabric/agents-mcp@0.48.5

## 0.48.4

### Patch Changes

- 37e72ed: Now localhost origins are only allowed when ENVIRONMENT is development or test. In production/pentest, CORS will require either AGENT_FABRIC_AGENTS_MANAGE_UI_URL to be set or the origin to share the same base
- Updated dependencies [11f4e14]
- Updated dependencies [2a91f04]
  - @agent-fabric/agents-core@0.48.4
  - @agent-fabric/agents-work-apps@0.48.4
  - @agent-fabric/agents-manage-mcp@0.48.4
  - @agent-fabric/agents-mcp@0.48.4
...
- Updated dependencies [79dffed]
  ...
  - @agent-fabric/agents-work-apps@0.48.3
  - @agent-fabric/agents-manage-mcp@0.48.3
  - @agent-fabric/agents-mcp@0.48.3
...
- @agent-fabric/agents-manage-mcp@0.48.2
- @agent-fabric/agents-mcp@0.48.2
- @agent-fabric/agents-work-apps@0.48.2
...
- Updated dependencies [a0464cb]
  - @agent-fabric/agents-work-apps@0.48.1
  - @agent-fabric/agents-core@0.48.1
  - @agent-fabric/agents-manage-mcp@0.48.1
  - @agent-fabric/agents-mcp@0.48.1
...
- Updated dependencies [b2a6078]
  ...
  - @agent-fabric/agents-work-apps@0.48.0
  - @agent-fabric/agents-manage-mcp@0.48.0
  - @agent-fabric/agents-mcp@0.48.0
...
- @agent-fabric/agents-manage-mcp@0.47.5
- @agent-fabric/agents-mcp@0.47.5
- @agent-fabric/agents-work-apps@0.47.5
...
- Updated dependencies [5f3f5ea]
  ...
  - @agent-fabric/agents-work-apps@0.47.4
  - @agent-fabric/agents-manage-mcp@0.47.4
  - @agent-fabric/agents-mcp@0.47.4
...
- Updated dependencies [045c405]
  - @agent-fabric/agents-work-apps@0.47.3
  - @agent-fabric/agents-core@0.47.3
  - @agent-fabric/agents-manage-mcp@0.47.3
  - @agent-fabric/agents-mcp@0.47.3
...
- Updated dependencies [c5357e5]
  - @agent-fabric/agents-manage-mcp@0.47.2
  - @agent-fabric/agents-core@0.47.2
  - @agent-fabric/agents-mcp@0.47.2
  - @agent-fabric/agents-work-apps@0.47.2
...
- Updated dependencies [6fbe785]
  ...
  - @agent-fabric/agents-work-apps@0.47.1
  - @agent-fabric/agents-manage-mcp@0.47.1
  - @agent-fabric/agents-mcp@0.47.1
...
- Updated dependencies [cfee934]
  ...
  - @agent-fabric/agents-work-apps@0.47.0
  - @agent-fabric/agents-manage-mcp@0.47.0
  - @agent-fabric/agents-mcp@0.47.0
...
- Updated dependencies [6139d11]
  ...
  - @agent-fabric/agents-work-apps@0.46.1
  - @agent-fabric/agents-manage-mcp@0.46.1
  - @agent-fabric/agents-mcp@0.46.1
...
- Updated dependencies [12ad286]
  ...
  - @agent-fabric/agents-manage-mcp@0.46.0
  - @agent-fabric/agents-mcp@0.46.0
  - @agent-fabric/agents-work-apps@0.46.0
...
- Updated dependencies [632d68d]
  ...
  - @agent-fabric/agents-work-apps@0.45.3
  - @agent-fabric/agents-manage-mcp@0.45.3
  - @agent-fabric/agents-mcp@0.45.3
...
- Updated dependencies [4524c28]
  ...
  - @agent-fabric/agents-work-apps@0.45.2
  - @agent-fabric/agents-manage-mcp@0.45.2
  - @agent-fabric/agents-mcp@0.45.2
...
- Updated dependencies [21e6ae5]
  - @agent-fabric/agents-work-apps@0.45.1
  - @agent-fabric/agents-manage-mcp@0.45.1
  - @agent-fabric/agents-core@0.45.1
  - @agent-fabric/agents-mcp@0.45.1
...
- Updated dependencies [6f5bd15]
  - @agent-fabric/agents-work-apps@0.45.0
  - @agent-fabric/agents-core@0.45.0
  - @agent-fabric/agents-manage-mcp@0.45.0
  - @agent-fabric/agents-mcp@0.45.0
...
- Updated dependencies [ba853ef]
  ...
  - @agent-fabric/agents-work-apps@0.44.0
  - @agent-fabric/agents-manage-mcp@0.44.0
  - @agent-fabric/agents-mcp@0.44.0
...
- Updated dependencies [cfa81bb]
  ...
  - @agent-fabric/agents-manage-mcp@0.43.0
  - @agent-fabric/agents-mcp@0.43.0
...
- Updated dependencies [82afd5b]
  ...
  - @agent-fabric/agents-manage-mcp@0.42.0
