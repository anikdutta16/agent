  ...
  if (!hasWorkspace) {
    return (
      <EmptyState
        ...
        description="Install the Agent Fabric Agent to your Slack workspace to enable AI-powered responses to @mentions and /agent-fabric commands."
        action={
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {workspace.hasDefaultAgent ? (
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            The default agent for all <code>@Agent Fabric</code> mentions and{' '}
                            <code>/agent-fabric</code> commands in {workspace.teamName}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    ) : (
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            ...
                            <code>@Agent Fabric</code> mentions or <code>/agent-fabric</code>{' '}
                            commands
                          </p>
                        </TooltipContent>
                      </Tooltip>
      ...
      <AlertDialog open={showUninstallDialog} onOpenChange={setShowUninstallDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will remove the Agent Fabric Agent from this Slack workspace. All channel
