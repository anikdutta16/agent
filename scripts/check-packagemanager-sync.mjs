...
const monorepoRoot = process.env.AGENT_FABRIC_PRIVATE_MONOREPO
...
if (monorepoRoot) {
  ...
  console.log(
    'Not running in monorepo context (AGENT_FABRIC_PRIVATE_MONOREPO not set), skipping root checks'
  );
}
