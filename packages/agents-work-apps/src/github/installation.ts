  ...
  try {
    ...
    if (response.status === 404) {
      return {
        ...
        message: `GitHub App is not installed on repository ${repositoryOwner}/${repositoryName}. Please install the Agent Fabric GitHub App on the repository to enable token exchange.`,
      };
    }
