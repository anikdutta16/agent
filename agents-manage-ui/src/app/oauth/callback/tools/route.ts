 ...
 * Only active when PUBLIC_IS_AGENT_FABRIC_CLOUD_DEPLOYMENT=true.
 *
...
export async function GET(request: NextRequest) {
  ...
  const isCloudDeployment =
    process.env.PUBLIC_IS_AGENT_FABRIC_CLOUD_DEPLOYMENT === 'true' ||
    process.env.NEXT_PUBLIC_IS_AGENT_FABRIC_CLOUD_DEPLOYMENT === 'true';
