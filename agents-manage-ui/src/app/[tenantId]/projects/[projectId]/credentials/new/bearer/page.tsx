'use client';
import { generateIdFromName } from '@agent-fabric/agents-core/client-exports';
import { CredentialStoreType } from '@agent-fabric/agents-core/types';
import { useRouter } from 'next/navigation';
import { use, useEffect } from 'react';
import { toast } from 'sonner';
import { CredentialForm } from '@/components/credentials/views/credential-form';
import { CredentialFormAgentFabricCloud } from '@/components/credentials/views/credential-form-agent-fabric-cloud';
...
export default function NewCredentialForm({
  ...
  const FormToUse =
    PUBLIC_IS_AGENT_FABRIC_CLOUD_DEPLOYMENT === 'true'
      ? CredentialFormAgentFabricCloud
      : CredentialForm;
