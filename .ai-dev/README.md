...
| `*.localhost` | Full | Organization services |
| `api.github.com` | Full | GitHub API (PR, reviews, CI) |
| `github.com/agent-fabric/*` | Path-restricted | Git push/pull (org repos only) |
| `*.githubusercontent.com/agent-fabric/*` | Path-restricted | GitHub raw content |
