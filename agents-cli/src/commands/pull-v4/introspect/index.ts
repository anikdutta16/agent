...
import type { FullProjectDefinition } from '@agent-fabric/agents-core';
...
export async function pullV4Command(options: PullV3Options): Promise<PullResult | undefined> {
  ...
  try {
    ...
    console.log(
      styleText(
        'yellow',
        '⚠️  If you encounter broken code after running `agent-fabric pull`, please report it at https://github.com/agent-fabric/agents/issues.'
      )
    );
