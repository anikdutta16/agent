...
export const metadata: Metadata = {
  ...
  description:
    "Agent Fabric's multi-agent framework enables multiple specialized AI agents to collaborate and solve complex problems through an agent-based architecture. You can define networks of agents, each with unique instructions, tools, and purposes.",
  keywords: ['agents', 'ai', 'framework', 'sdk', 'agent-fabric'],
  generator: 'Next.js',
  ...
  other: {
    'msapplication-TileColor': AGENT_FABRIC_BRAND_COLOR,
  },
  twitter: {
    creator: process.env.METADATA_TWITTER_CREATOR || '@agent-fabric',
    site: process.env.METADATA_TWITTER_SITE || 'http://localhost',
  },
